    ...
    <div className="course-info">
      <div className="course-info-header">
        ...
        <ul className="courses-card-header-tags">
          {course.tags.map((item) => (
            <li className="courses-card-header-tag">#{item.title}</li>
          ))}
      ...
      <div className="course-info-main">
        <div className="course-info-main-text">
          <p className="course-info-main-text-desc">{course.excerpt}</p>
          ...
          <div className="course-info-bottom">
            <div className="course-info-bottom-left">
              ...
              <p className="created-course-bottom-date">
                &gt; {course.username}, {course.role === 'admin' ? 'Администратор' : 'Пользователь'}
      ...
      <div className="course-info-button">
        <button onClick={() => navigate('study')} className="btn primary big">
          {course.success === 0 ? 'Начать прохождение курса' : 'Продолжить прохождение курса'}
        </button>
        {/* <Link to={'study'} className="btn primary big"> */}
