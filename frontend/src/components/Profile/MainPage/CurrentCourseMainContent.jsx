        ...
        <div className="currentcourse-course-content">
            <div className="currentcourse-course">
                <div className="currentcourse-course-info">
                    {/*<p className="currentcourse-course-info-title">*/}
                    {/*    <ClampLines*/}
                    {/*        text={`_${data[index].title}`}*/}
                    {/*        id={index}*/}
                    {/*        lines={1}*/}
                    {/*        className={'currentcourse-course-info-title'}*/}
                    {/*        ellipsis={'...'}*/}
                    {/*        innerElement={"span"}*/}
                    {/*    />*/}
                    <Link to={'/'} className="currentcourse-course-info-title clamp-text">
                        _{data[index].title}
                    </Link>
                    {/*</p>*/}
