    ...
    <div className={`profile-current-card ${isCreated ? 'created-card' : ''}`}>
      <ul className="created-course-header-tags">
        {data.tags.map((item, i) => (
          <li key={i} className="created-course-header-tag">
            #{item.title}
          </li>
        ))}
      </ul>
      ...
      <div className="created-course-cards">
        <div className="created-course-card">
          ...
          <p className="created-course-card-text">
            {viewWords['tpl_profile_course-card_amount-block']}: {data.amount_stage}
          </p>
        </div>
        <div className="created-course-card">
          <svg
          ...
          <p className="created-course-card-text">
            {viewWords['tpl_profile_course-card_amount-lesson']}: {data.amount_step}
          </p>
        </div>
        <div className="created-course-card">
          <svg
      ...
      <div className="profile-completed-card-about">
        <p>
          {!isCreated
            ? `> ${data.username}, ${viewWords[`tpl_profile_card_role-${data.role}`]}, `
            : ''}
      ...
      {isCreated ? (
        ...
        <div className="profile-completed-card-progress">
          ...
          <p className="profile-completed-card-progress-value">
            {data.current_stage}/{data.amount_stage}
          </p>
        </div>
      )}
      {isContinue ? (
        <div className="profile-current-card-button">
          <Link to={`{../../course/${data.slug}/study`} className="btn big primary">
            {viewWords['tpl_profile_current-courses_continue']}
          </Link>
        </div>
      ) : (
        <></>
