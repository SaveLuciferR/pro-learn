        ...
        <div className={`profile-current-card ${isCreated ? 'created-card' : ''}`}>
                ...
                <ul className="profile-difficulty-range">

                    {
                        Array(5).fill('').map((item, i) =>
                            <li className={`profile-difficulty-range-item ${i < data.difficulty ? 'active' : ''}`}></li>
                        )
                    }
                </ul>
            </div>
            <div className="created-course-cards">
                <div className="created-course-card">
                    ...
                    <p className="created-course-card-text">{viewWords['tpl_profile_course-card_amount-block']}: {data.amount_stage}</p>
                </div>
                <div className="created-course-card">
                    <svg
                        className="created-course-card-img"
                    ...
                    <p className="created-course-card-text">{viewWords['tpl_profile_course-card_amount-lesson']}: {data.amount_step}</p>
                </div>
                <div className="created-course-card">
                    <svg
                        className="created-course-card-img"
                    ...
                    <p className="created-course-card-text">
                        {viewWords['tpl_profile_course-card_finish-project']}: {data.final_projects}
                    </p>
                </div>
            </div>
                    ...
                    {isCreated ?
                        <>
                            ...
                            <div className="created-course-stat-ended">
                                ...
                                <p>Окончили: {data.finish_users}</p>
                            </div>
                        </>
                        :
                        <></>
            ...
            <div className="profile-completed-card-about">
                <p>
                    {!isCreated ? `> ${data.username}, ${viewWords[`tpl_profile_card_role-${data.role}`]}, ` : ''}
                    {data.date_of_publication === null ? 'Не обуликовано' : data.date_of_publication}
                </p>
                <p className="profile-completed-card-stat-lang">
                    {data.language.length === 0 ?
                        ''
                        :
                        `// ${viewWords['tpl_profile_card_language']}: ${getLanguage()}`
                    }
                </p>
            </div>
            {isCreated ?
            ...
            }
            {
                isContinue ?
                    <div className="profile-current-card-button">
                        <Link to={`{../../course/${data.slug}/study`}
                              className="btn big primary">{viewWords['tpl_profile_current-courses_continue']}</Link>
                    </div>
                    :
                    <></>
            }
...
export default ProfileCoursesItem;
