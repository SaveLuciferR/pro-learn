                ...
                <ul className={`dropdown-menu  ${dropdownActive ? 'active' : ''}`}>
                  {Object.keys(languages).map((key) =>
                    language.code === key ? (
                      ...
                      <li key={key} onClick={(e) => setNewLanguage(e)} id={key} data-id={key}>
                        {languages[key].title}
                      </li>
                    ),
                  )}
            ...
            <div className="header_icons">
              ...
              <div onClick={() => onClickActiveSidebar()} className="header_icons__icon">
                ...
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <circle cx="14" cy="10.5" r="3.5" stroke="white" strokeWidth="1.5" />
                  <circle cx="13.9999" cy="14" r="11.6667" stroke="white" strokeWidth="1.5" />
                  <path
