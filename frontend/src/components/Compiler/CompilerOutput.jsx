    ...
    <div className="output">
      <div className="output-tabs">
        <div className={'output-buttons'}>
          <button className={'btn btn-without_text'}>
            <VscChevronLeft className={'icon-24'} />
          </button>
          <button className={'btn btn-without_text'}>
            <VscChevronRight className={'icon-24'} />
          </button>
          <button
            onClick={() => dispatch(setNeedReloadFrameCompiler(true))}
            className={'btn btn-without_text'}
          >
            <GrRefresh className={'icon-24'} />
          </button>
        </div>
        <input
          type={'text'}
          className={'input width100 output-search'}
          value={path}
          onChange={(e) => setPath(e.target.value)}
        />
        <div className={'output-buttons'}>
          <button className={'btn btn-without_text'}>
            <IoIosArrowForward className={'icon-24'} />
          </button>
        </div>
