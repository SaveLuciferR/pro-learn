  ...
  useEffect(() => {
    ...
    if (activeTabClosed) {
      if (Object.keys(tabs).length === 0) {
        ...
        dispatch(
          setCompilerCurrentFile(tabs[Object.keys(tabs)[0]].file, tabs[Object.keys(tabs)[0]].name),
        );
      }
    }
  }, [tabs]);
        ...
        <div className={`editor-tabs`}>
          ...
          <div className={`editor-tabs-button`}>
            {isWebProject ? (
              ...
              <button onClick={() => handleStartDocker()} className={'btn btn-without_text'}>
                <VscDebugStart className={'icon-24'} />
              </button>
            )}
          </div>
        </div>
