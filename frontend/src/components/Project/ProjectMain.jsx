    ...
    return (
        <>
                ...
                <div className="project__info-inner">
                    ...
                    <div className="project__info-public">
                        ...
                        <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M15.75 7.875C17.1997 7.875 18.375 6.89562 18.375 5.6875C18.375 4.47938 17.1997 3.5 15.75 3.5" stroke="white" strokeOpacity="0.6" strokeLinecap="round" />
                            <path d="M5.25 7.875C3.80025 7.875 2.625 6.89562 2.625 5.6875C2.625 4.47938 3.80025 3.5 5.25 3.5" stroke="white" strokeOpacity="0.6" strokeLinecap="round" />
                            <ellipse cx="10.5" cy="14.875" rx="5.25" ry="3.5" stroke="white" strokeOpacity="0.6" />
                            <path d="M17.5 16.625C19.035 16.2884 20.125 15.4359 20.125 14.4375C20.125 13.4391 19.035 12.5866 17.5 12.25" stroke="white" strokeOpacity="0.6" strokeLinecap="round" />
                            <path d="M3.5 16.625C1.96503 16.2884 0.875 15.4359 0.875 14.4375C0.875 13.4391 1.96503 12.5866 3.5 12.25" stroke="white" strokeOpacity="0.6" strokeLinecap="round" />
                        </svg>
            ...
            <div className="project__last-info">
                <div>&gt; <span><Link to="/">{projectInfo.info.username}</Link></span>, {projectInfo.info.role === 'admin' ? "Администрация" : "Пользователь"}, {projectInfo.info.date_of_publication}</div>
