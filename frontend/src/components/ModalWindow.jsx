  ...
  return (
    <div className="modal" style={isWindowShowed === true ? {} : { display: 'none' }}>
      <div className="modal-window">
        ...
        <h1 className="modal-window-title">Вы действительно хотите удалить аккаунт?</h1>
        <p
          className="modal-window-content"
          style={isContentShowed === true ? {} : { display: 'none' }}
        >
          Если Вы удалите свой аккаунт, то безвозвратно потеряете свои курсы, задачи, прогресс, код,
        ...
        >
          ...
          <button onClick={() => answerButton(false)} className="btn big primary">
            Отмена
          </button>
        </div>
      </div>
