...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Сен 18 2023 г., 17:48
...
(1, 1, 'Привет, Мир!', 'Это тестовый блог, так что Привет,', '<p>Это тестовый блог, так что Привет, <strong>Мир</strong>!<img src=\"/public/uploads/images/coffi.png\"></p><p><a href=\"https://youtube\">https://youtube</a></p><p>А это конец блога</p>', 'Привет, Мир', 'Привет, Мир! - описание', 'Привет, Мир! - ключевые'),
...
INSERT INTO `langprog` (`id`, `title`, `icon_img`, `color`) VALUES
(1, 'Java', '/public/uploads/java.svg', '#444444'),
(2, 'JavaScript', '/public/uploads/js.svg', '#888888'),
...
CREATE TABLE `project` (
  ...
  `slug` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `path_project` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `date_of_publication` date NOT NULL,
...
(1, 2, 'find-square-triangle', 'Найти площадь треугольника', '/public/project/user/find-the-area-of-the-triangle', '2023-05-12', 0, 'Программа для поиска площади треугольника по основанию и его высоте.');
...
CREATE TABLE `user_achievement` (
  ...
  `max_pogress` int(10) UNSIGNED NOT NULL,
  `date_of_reciept` date DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `user_achievement` (`user_id`, `achievement_id`, `progress`, `max_pogress`, `date_of_reciept`) VALUES
(2, 1, 1, 1, '2023-05-10'),
(2, 2, 2, 3, NULL);
