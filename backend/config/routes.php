...
Router::add('^(?P<lang>[a-z]+)?/?@(?P<username>[a-z-0-9A-Z]+)/project-save/?$', ['controller' => 'User', 'action' => 'saveProject']);
Router::add('^(?P<lang>[a-z]+)?/?@(?P<username>[a-z-0-9A-Z]+)/project-add/new-files/?$', ['controller' => 'User', 'action' => 'addNewFiles']);
Router::add('^(?P<lang>[a-z]+)?/?@(?P<username>[a-z-0-9A-Z]+)/project-add/get-project-in-cache/?$', ['controller' => 'User', 'action' => 'getProjectInCache']);
